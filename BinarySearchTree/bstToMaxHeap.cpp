...
Traverse in the inorder array and fill the tree by traversing in the postorder traversal technique that is left, right, node */
// { Driver Code Starts
...
public:
    ...
    void postorder(Node *root, vector<int> &res, int &idx)
    {
        if (root)
        {
